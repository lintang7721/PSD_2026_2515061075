...
OUTPUT PROGRAM
<img width="808" height="275" alt="Screenshot 2026-05-04 194711" src="https://github.com/user-attachments/assets/a468c73a-828b-478b-9275-eee21226f628" />
- Pada saat program dijalankan hal yang pertama muncul adalah perintah agar pengguna memasukkan jumlah mahasiswa yang diinginkan, karena saya memasukkan 3 maka program akan memproses data untuk 3 orang mahasiswa.
- Kemudian program akan meminta pengguna untuk menginputkan nilai IPK mahasiswa. Disini saya menginputkan IPK mahasiswa pertama yaitu (3.65), mahasiswa kedua (3.70), mahasiswa ketiga (3.00).
- Begitu IPK terakhir diinputkan, program akan langsung menampilkan tulisan Data IPK sebelum diurutkan. Terlihat bahwa angka 3.65 masih berada paling ujung karena belum diproses sama sekali.
- Pada baris terakhir program menampilkan Data IPK setelah diurutkan. Terlihat bahwa urutan data IPK sudah sesuai yaitu dari terkecil ke terbesar. Angka 3.00 yang tadinya berada di posisi paling belakang sekarang pindah posisi ke depan karena sistem pengurutannya membandingkan nilai satu per satu.

LINK YOUTUBE
https://youtu.be/oK7lZHEz9Qw?si=xiYTt5qKD1AUTgIk
